...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <title><?php echo $activeMenuItem[1]; ?></title>
  ...
  function setCookie(name, value, days) {
    ...
    <body>
        ...
        <div
            class="dropdown position-fixed bd-mode-toggle bottom-0 end-0 mb-3 me-3"
        >
            <button
        ...
        <main>
            <div class="container">
                ...
                >
                    ...
                    >
                        <span class="fs-4"><?php echo $activeMenuItem[2]; ?></span>
                    </a>
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a href="/" class="nav-link <?php echo $activeMenuItem[0] ===
                            "home"
                                ? "active"
                                : ""; ?>">Home</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="/settings" class="nav-link <?php echo $activeMenuItem[0] ===
                            "settings"
                                ? "active"
                                : ""; ?>">Settings</a>
                        </li>
                        <li class="nav-item">
                            <a href="/tracker" class="nav-link <?php echo $activeMenuItem[0] ===
                            "tracker"
                                ? "active"
                                : ""; ?>">Tracker</a>
                        </li>
